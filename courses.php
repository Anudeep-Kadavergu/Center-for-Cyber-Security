...
<title>Vardhman Center for Cyber Security | Courses</title>
...
$sql="select * from tbl_login where value='$value'";
 $result= mysqli_query($connection,$sql);
    ...
    <div class="header-limiter">
        ...
        <a href="index" style="padding: 0 12px"><div class="header-user-menu">
...
<div id="content_wrapper">
    ...
    <div id="content" class="content-mobile">
        ...
        <h2><span>Center Courses</span></h2><br><br>
        
        <h2> Networking Courses</h2>
        <?php
    $sql="SELECT * FROM tbl_course where category='Networking'";
    $result_set=mysqli_query($connection,$sql);
    $i=1;
    while($row=mysqli_fetch_array($result_set)){
        ?>
        <p ><a href="<?php echo $row['link']?>" style="text-decoration: none;"><?php echo $i.".".$row['course'];$i=$i+1; ?></a></p><?php
    }
    ?>
<h2> Security Courses</h2>
        <?php
    $sql="SELECT * FROM tbl_course where category='Security'";
    $result_set=mysqli_query($connection,$sql);
    $i=1;
    while($row=mysqli_fetch_array($result_set)){
        ?>
    ...
    ?>
<h2> IoT & Data Analytics Courses</h2>
        <?php
    $sql="SELECT * FROM tbl_course where category='IoT & Data Analytics'";
    $result_set=mysqli_query($connection,$sql);
    $i=1;
    while($row=mysqli_fetch_array($result_set)){
        ?>
...
<h2> OS & It Courses</h2>
        ...
        <?php
    $sql="SELECT * FROM tbl_course where category='OS & It'";
    $result_set=mysqli_query($connection,$sql);
    $i=1;
    while($row=mysqli_fetch_array($result_set)){
        ?>
...
<h2> Programming Courses</h2>
    ...
    ?>
<h2> Emerging Technologies Workshop</h2>
        <?php
    $sql="SELECT * FROM tbl_course where category='Networking'";
    $result_set=mysqli_query($connection,$sql);
    $i=1;
