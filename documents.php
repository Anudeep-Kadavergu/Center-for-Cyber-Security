...
<title>Vardhman Center for Cyber Security | Documents</title>
...
<div id="content_wrapper">
    ...
    while($row=mysqli_fetch_array($result_set)){
      ...
      <p><a href="uploads/<?php echo $row['file'];?>" style="text-decoration: none;"><?php echo $i.".".$row['title'];$i=$i+1; ?></a><br></p><?php } ?>
