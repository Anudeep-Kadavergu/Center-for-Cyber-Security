...
<title>Vardhman Center for Cyber Security | Achievements</title>
...
<div id="content_wrapper">
    ...
    <div id="content" class="content-mobile">
        <h2> Center <span>Achievements</span></h2>
        <?php
    $sql="SELECT * FROM tbl_achievements";
    $result_set=mysqli_query($connection,$sql);
    $i=1;
    while($row=mysqli_fetch_array($result_set)){
        ?><p><a style="text-decoration: none;" href="uploads/<?php echo $row['file'];?>">
         <?php echo $i.".".$row['subject'];$i=$i+1; ?>--<?php echo $row['mail'] ?>--<?php echo $row['daate'] ?><br></a><?php
    }
    ?>
