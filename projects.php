...
<title>Vardhman Center for Cyber Security | Projects</title>
...
<div id="content_wrapper">
    ...
    while($row=mysqli_fetch_array($result_set)){
        ...
        ?>
        <p><a href="uploads/<?php echo $row['file'];?>" style="text-decoration: none;">
     <?php echo $i.".".$row['title'];$i=$i+1; ?></a>-- <?php echo $rowf['name']; ?><br><br>
...
?>
<h2><span>R&D Projects</span></h2>
<?php
    $sql="SELECT * FROM tbl_rd";
    $result_set=mysqli_query($connection,$sql);
    $i=1;
    while($row=mysqli_fetch_array($result_set)){
        $id=$row['faculty'];
        ...
        $rowf=mysqli_fetch_array($resultf);
        ?>
<p> <a href="uploads/<?php echo $row['file'];?>" style="text-decoration: none;"> <?php echo $i.".".$row['title'];$i=$i+1; ?></a>--<?php echo $rowf['name']; ?><br><br>
